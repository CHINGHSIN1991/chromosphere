...
// - Ark UI CheckboxLabel Solid 版本：
//   https://github.com/chakra-ui/ark/blob/main/packages/solid/src/components/checkbox/checkbox-label.tsx
// =============================================================================

export interface CheckboxLabelProps extends ComponentProps<'span'> {
  // TODO: 額外 props
}
