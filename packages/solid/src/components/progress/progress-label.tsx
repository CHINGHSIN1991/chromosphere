...
// - Ark UI ProgressLabel Solid 版本：
//   https://github.com/chakra-ui/ark/blob/main/packages/solid/src/components/progress/progress-label.tsx
// =============================================================================

export interface ProgressLabelProps extends ComponentProps<'label'> {
  // TODO: 額外 props
}
