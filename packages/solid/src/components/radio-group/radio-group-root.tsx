...
// =============================================================================
// TODO: 實作 RadioGroupRoot（Solid 版）
// =============================================================================
//
// 💡 Solid 與 React 的主要差異：
...
// - Context：用 <RadioGroupContext.Provider value={...}> 包住
//
// 架構重點：
...
// - Zag.js 參考: https://zagjs.com/components/react/radio-group
// =============================================================================

export interface RadioGroupRootProps extends ParentProps {
  // TODO: 定義 props
}
