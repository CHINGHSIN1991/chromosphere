...
// =============================================================================
// TODO: 實作 RadioGroupItemHiddenInput（Solid 版）
// =============================================================================
//
...
// - Ark UI RadioGroupItemHiddenInput Solid 版本：
//   https://github.com/chakra-ui/ark/blob/main/packages/solid/src/components/radio-group/radio-group-item-hidden-input.tsx
// =============================================================================

export interface RadioGroupItemHiddenInputProps extends ComponentProps<'input'> {
  // TODO: 額外 props
}
