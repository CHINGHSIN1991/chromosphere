...
// - Ark UI SwitchLabel Solid 版本：
//   https://github.com/chakra-ui/ark/blob/main/packages/solid/src/components/switch/switch-label.tsx
// =============================================================================

export interface SwitchLabelProps extends ComponentProps<'span'> {
  // TODO: 額外 props
}
