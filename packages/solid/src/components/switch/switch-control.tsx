...
// - Ark UI SwitchControl Solid 版本：
//   https://github.com/chakra-ui/ark/blob/main/packages/solid/src/components/switch/switch-control.tsx
// =============================================================================

export interface SwitchControlProps extends ComponentProps<'span'> {
  // TODO: 額外 props
}
