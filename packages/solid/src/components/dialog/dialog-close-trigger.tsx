...
// =============================================================================
// TODO: 實作 DialogCloseTrigger（Solid 版）
// =============================================================================
//
// 功能說明：關閉 Dialog 的按鈕
//
...
// - Ark UI DialogCloseTrigger Solid 版本：
//   https://github.com/chakra-ui/ark/blob/main/packages/solid/src/components/dialog/dialog-close-trigger.tsx
// =============================================================================

export interface DialogCloseTriggerProps extends ComponentProps<'button'> {
  // TODO: 額外 props
}
