...
// - Ark UI PopoverTitle Solid 版本：
//   https://github.com/chakra-ui/ark/blob/main/packages/solid/src/components/popover/popover-title.tsx
// =============================================================================

export interface PopoverTitleProps extends ComponentProps<'h3'> {
  // TODO: 額外 props
}
