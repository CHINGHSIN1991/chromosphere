...
// - Ark UI RadioGroupItemText 實作參考：
//   https://github.com/chakra-ui/ark/blob/main/packages/react/src/components/radio-group/radio-group-item-text.tsx
// =============================================================================

export interface RadioGroupItemTextProps extends ComponentPropsWithoutRef<'span'> {
  // TODO: 是否需要額外的 props？
}
