...
// - Ark UI SwitchControl 實作參考：
//   https://github.com/chakra-ui/ark/blob/main/packages/react/src/components/switch/switch-control.tsx
// =============================================================================

export interface SwitchControlProps extends ComponentPropsWithoutRef<'span'> {
  // TODO: 是否需要額外的 props？
}
