...
// - Ark UI PopoverCloseTrigger 實作參考：
//   https://github.com/chakra-ui/ark/blob/main/packages/react/src/components/popover/popover-close-trigger.tsx
// =============================================================================

export interface PopoverCloseTriggerProps extends ComponentPropsWithoutRef<'button'> {
  // TODO: 是否需要額外的 props？
}
