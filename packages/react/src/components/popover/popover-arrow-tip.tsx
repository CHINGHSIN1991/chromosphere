...
// =============================================================================
// TODO: 實作 PopoverArrowTip
// =============================================================================
//
// 功能說明：箭頭尖端（通常用 SVG 或 CSS transform）
//
// 💡 提示：
// Step 1 — 從 Context 讀取需要的狀態
//   使用 usePopoverContext() 取得所需資料
//
// Step 2 — ARIA 無障礙屬性
//   參考 https://www.w3.org/WAI/ARIA/apg/patterns/popover/
...
// - Ark UI PopoverArrowTip 實作參考：
//   https://github.com/chakra-ui/ark/blob/main/packages/react/src/components/popover/popover-arrow-tip.tsx
// =============================================================================

export interface PopoverArrowTipProps extends ComponentPropsWithoutRef<'div'> {
  // TODO: 是否需要額外的 props？
}
