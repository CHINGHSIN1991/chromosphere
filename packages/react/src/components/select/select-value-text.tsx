...
// - Ark UI SelectValueText 實作參考：
//   https://github.com/chakra-ui/ark/blob/main/packages/react/src/components/select/select-value-text.tsx
// =============================================================================

export interface SelectValueTextProps extends ComponentPropsWithoutRef<'span'> {
  // TODO: 是否需要額外的 props？
}
