...
// - Ark UI ProgressLabel 實作參考：
//   https://github.com/chakra-ui/ark/blob/main/packages/react/src/components/progress/progress-label.tsx
// =============================================================================

export interface ProgressLabelProps extends ComponentPropsWithoutRef<'label'> {
  // TODO: 是否需要額外的 props？
}

export const ProgressLabel = forwardRef<HTMLLabelElement, ProgressLabelProps>(
  (props, ref) => {
    // TODO: 從 Context 讀取狀態
