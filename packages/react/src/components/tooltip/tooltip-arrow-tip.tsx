...
// - Ark UI TooltipArrowTip 實作參考：
//   https://github.com/chakra-ui/ark/blob/main/packages/react/src/components/tooltip/tooltip-arrow-tip.tsx
// =============================================================================

export interface TooltipArrowTipProps extends ComponentPropsWithoutRef<'div'> {
  // TODO: 是否需要額外的 props？
}
