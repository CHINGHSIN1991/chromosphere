...
// - Ark UI DialogCloseTrigger 實作參考：
//   https://github.com/chakra-ui/ark/blob/main/packages/react/src/components/dialog/dialog-close-trigger.tsx
// =============================================================================

export interface DialogCloseTriggerProps extends ComponentPropsWithoutRef<'button'> {
  // TODO: 是否需要額外的 props？
}
