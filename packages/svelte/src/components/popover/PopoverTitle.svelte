<script lang="ts">
  // ===========================================================================
  // TODO: 實作 PopoverTitle（Svelte 5 版）
  // ===========================================================================
  //
  // 功能說明：Popover 標題
  //
  ...
  // - Ark UI PopoverTitle Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/popover/PopoverTitle.svelte
  // ===========================================================================
