<script lang="ts">
  // ===========================================================================
  // TODO: 實作 PopoverArrow（Svelte 5 版）
  // ===========================================================================
  //
  // 功能說明：箭頭容器
  //
  ...
  // - Ark UI PopoverArrow Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/popover/PopoverArrow.svelte
  // ===========================================================================
