<script lang="ts">
  // ===========================================================================
  // TODO: 實作 PopoverArrowTip（Svelte 5 版）
  // ===========================================================================
  //
  ...
  //   import { getPopoverContext } from './popover-context.svelte.ts'
  ...
  // - Ark UI PopoverArrowTip Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/popover/PopoverArrowTip.svelte
  // ===========================================================================
