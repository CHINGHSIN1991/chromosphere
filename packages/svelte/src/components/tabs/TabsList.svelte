<script lang="ts">
  // ===========================================================================
  // TODO: 實作 TabsList（Svelte 5 版）
  // ===========================================================================
  //
  // 功能說明：Tab 按鈕的列表容器（role="tablist"）
  //
  // 💡 提示：
  ...
  // - Ark UI TabsList Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/tabs/TabsList.svelte
  // ===========================================================================
