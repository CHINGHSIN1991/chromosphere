<script lang="ts">
  // ===========================================================================
  // TODO: 實作 TabsTrigger（Svelte 5 版）
  // ===========================================================================
  //
  // 功能說明：單一 tab 觸發按鈕（role="tab"）
  //
  // 💡 提示：
  // Step 1 — 從 Context 讀取狀態
  //   import { getTabsContext } from './tabs-context.svelte.ts'
  ...
  // - Ark UI TabsTrigger Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/tabs/TabsTrigger.svelte
  // ===========================================================================
