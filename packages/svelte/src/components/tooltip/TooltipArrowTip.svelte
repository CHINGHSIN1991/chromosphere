<script lang="ts">
  // ===========================================================================
  // TODO: 實作 TooltipArrowTip（Svelte 5 版）
  // ===========================================================================
  //
  // 功能說明：箭頭尖端
  //
  ...
  // - Ark UI TooltipArrowTip Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/tooltip/TooltipArrowTip.svelte
  // ===========================================================================
