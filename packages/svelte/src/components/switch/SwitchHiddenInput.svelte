<script lang="ts">
  // ===========================================================================
  // TODO: 實作 SwitchHiddenInput（Svelte 5 版）
  // ===========================================================================
  //
  ...
  //   import { getSwitchContext } from './switch-context.svelte.ts'
  ...
  // - Ark UI SwitchHiddenInput Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/switch/SwitchHiddenInput.svelte
  // ===========================================================================
