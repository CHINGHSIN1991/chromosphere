<script lang="ts">
  // ===========================================================================
  // TODO: 實作 SwitchThumb（Svelte 5 版）
  // ===========================================================================
  //
  // 功能說明：滑動的圓形按鈕
  //
  ...
  // - Ark UI SwitchThumb Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/switch/SwitchThumb.svelte
  // ===========================================================================
