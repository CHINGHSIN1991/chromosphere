<script lang="ts">
  // ===========================================================================
  // TODO: 實作 CheckboxLabel（Svelte 5 版）
  // ===========================================================================
  //
  // 功能說明：勾選框的文字說明
  //
  ...
  // - Ark UI CheckboxLabel Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/checkbox/CheckboxLabel.svelte
  // ===========================================================================
