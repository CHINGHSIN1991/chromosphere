<script lang="ts">
  // ===========================================================================
  // TODO: 實作 RadioGroupItemControl（Svelte 5 版）
  // ===========================================================================
  //
  // 功能說明：視覺化的圓形按鈕
  //
  ...
  // - Ark UI RadioGroupItemControl Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/radio-group/RadioGroupItemControl.svelte
  // ===========================================================================
