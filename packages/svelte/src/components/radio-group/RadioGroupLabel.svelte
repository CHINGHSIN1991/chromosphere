<script lang="ts">
  // ===========================================================================
  // TODO: 實作 RadioGroupLabel（Svelte 5 版）
  // ===========================================================================
  //
  // 功能說明：整組的標籤
  //
  ...
  // - Ark UI RadioGroupLabel Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/radio-group/RadioGroupLabel.svelte
  // ===========================================================================
