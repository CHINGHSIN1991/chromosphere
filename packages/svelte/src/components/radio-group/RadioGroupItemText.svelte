<script lang="ts">
  // ===========================================================================
  // TODO: 實作 RadioGroupItemText（Svelte 5 版）
  // ===========================================================================
  //
  // 功能說明：選項文字
  //
  ...
  // - Ark UI RadioGroupItemText Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/radio-group/RadioGroupItemText.svelte
  // ===========================================================================
