<script lang="ts">
  // ===========================================================================
  // TODO: 實作 CollapsibleContent（Svelte 5 版）
  // ===========================================================================
  //
  // 功能說明：可收合的內容區域
  //
  ...
  // - Ark UI CollapsibleContent Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/collapsible/CollapsibleContent.svelte
  // ===========================================================================
