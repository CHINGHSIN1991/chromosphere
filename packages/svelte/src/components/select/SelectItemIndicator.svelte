<script lang="ts">
  // ===========================================================================
  // TODO: 實作 SelectItemIndicator（Svelte 5 版）
  // ===========================================================================
  //
  // 功能說明：選中狀態的勾選圖示
  //
  ...
  //   import { getSelectContext } from './select-context.svelte.ts'
  ...
  // - Ark UI SelectItemIndicator Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/select/SelectItemIndicator.svelte
  // ===========================================================================
