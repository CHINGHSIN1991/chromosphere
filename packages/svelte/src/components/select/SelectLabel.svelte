<script lang="ts">
  // ===========================================================================
  // TODO: 實作 SelectLabel（Svelte 5 版）
  // ===========================================================================
  //
  // 功能說明：選單標籤
  //
  ...
  // - Ark UI SelectLabel Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/select/SelectLabel.svelte
  // ===========================================================================
