<script lang="ts">
  // ===========================================================================
  // TODO: 實作 SelectValueText（Svelte 5 版）
  // ===========================================================================
  //
  // 功能說明：顯示目前選中的值文字
  //
  ...
  // - Ark UI SelectValueText Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/select/SelectValueText.svelte
  // ===========================================================================
