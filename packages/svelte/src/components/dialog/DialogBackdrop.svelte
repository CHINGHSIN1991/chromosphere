<script lang="ts">
  // ===========================================================================
  // TODO: 實作 DialogBackdrop（Svelte 5 版）
  // ===========================================================================
  //
  // 功能說明：背景遮罩（點擊可關閉）
  //
  ...
  // - Ark UI DialogBackdrop Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/dialog/DialogBackdrop.svelte
  // ===========================================================================
