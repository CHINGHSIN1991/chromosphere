<script lang="ts">
  // ===========================================================================
  // TODO: 實作 DialogContent（Svelte 5 版）
  // ===========================================================================
  //
  // 功能說明：Dialog 主體內容（role="dialog"）
  //
  // 💡 提示：
  ...
  // - Ark UI DialogContent Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/dialog/DialogContent.svelte
  // ===========================================================================
