<script lang="ts">
  // ===========================================================================
  // TODO: 實作 AvatarFallback（Svelte 5 版）
  // ===========================================================================
  //
  ...
  //   import { getAvatarContext } from './avatar-context.svelte.ts'
  ...
  // - Ark UI AvatarFallback Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/avatar/AvatarFallback.svelte
  // ===========================================================================
