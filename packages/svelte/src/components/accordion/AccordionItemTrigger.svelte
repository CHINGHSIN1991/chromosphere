<script lang="ts">
  // ===========================================================================
  // TODO: 實作 AccordionItemTrigger（Svelte 5 版）
  // ===========================================================================
  //
  // 功能說明：點擊觸發展開/收合
  //
  ...
  //   import { getAccordionContext } from './accordion-context.svelte.ts'
  ...
  // - Ark UI AccordionItemTrigger Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/accordion/AccordionItemTrigger.svelte
  // ===========================================================================
