<script lang="ts">
  // ===========================================================================
  // TODO: 實作 ProgressLabel（Svelte 5 版）
  // ===========================================================================
  //
  // 功能說明：進度條說明文字
  //
  ...
  // - Ark UI ProgressLabel Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/progress/ProgressLabel.svelte
  // ===========================================================================
