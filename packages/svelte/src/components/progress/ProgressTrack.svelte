<script lang="ts">
  // ===========================================================================
  // TODO: 實作 ProgressTrack（Svelte 5 版）
  // ===========================================================================
  //
  // 功能說明：進度條背景軌道
  //
  ...
  // - Ark UI ProgressTrack Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/progress/ProgressTrack.svelte
  // ===========================================================================
