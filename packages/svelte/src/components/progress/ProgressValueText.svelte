<script lang="ts">
  // ===========================================================================
  // TODO: 實作 ProgressValueText（Svelte 5 版）
  // ===========================================================================
  //
  // 功能說明：數值文字（如：75%）
  //
  ...
  //   import { getProgressContext } from './progress-context.svelte.ts'
  ...
  // - Ark UI ProgressValueText Svelte 版本：
  //   https://github.com/chakra-ui/ark/blob/main/packages/svelte/src/lib/components/progress/ProgressValueText.svelte
  // ===========================================================================
